...
as 
select ID [ID],  FirstName + ' ' + LastName [Full Name],Address [Address],Age [Age],Gender [Gender],Description [Description],Sick [Sick],Department [Department],Doctor [Dr.Manager],DateIn [DateIn],DateOut [DateOut],STT [In Hospital]
from tblPatient
go	
...
as
select ID [ID],  FirstName + ' ' + LastName [Full Name],Address [Address],Age [Age],Gender [Gender],Description [Description],Sick [Sick],Department [Department],Doctor [Dr.Manager],DateIn [DateIn],DateOut [DateOut],STT [In Hospital]
from tblPatient WHERE FirstName + ' ' + LastName = @Name
go
...
@DateIn smalldatetime
as
INSERT INTO tblPatient VALUES (@FName,@LName,@Address,@Age,@Gender,@Dep,'---',@Dec,@Dr,@DateIn,'--/--/----','No','0')
go
